...
class ProposalSearch extends Proposal
{
    ...
    {
        return [
            [['id', 'user_id', 'petani_id', 'provinsi_id', 'kabupatenkota_id', 'kecamatan_id', 'desakelurahan_id', 'komoditas_id', 'varietas_id', 'jenis_id', 'lapak_prov_id', 'lapak_kabkota_id', 'lapak_kec_id', 'lapak_desakel_id', 'jenis_bobot_kering_id', 'pasar_tag_id', 'pasar_id', 'versi'], 'integer'],
            [['created_at', 'updated_at', 'no_proposal', 'luas_unit', 'tgl_panen', 'tgl_tanam', 'est_bobot_basah', 'est_bobot_kering', 'est_tgl_kirim', 'kapasitas_periode', 'prop_kadaluarsa', 'setuju_status', 'setuju_alasan', 'setuju_berkas', 'picture'], 'safe'],
