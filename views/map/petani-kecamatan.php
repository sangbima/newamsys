...
$this->title = 'Map Info Sebaran Petani Per Kecamatan';
...
function initialize() {
  ...
  coba.forEach(function(element,index){
      ...
      position:new google.maps.LatLng(element.keclat,element.keclong),
      });

      pramarker.setMap(map);
      
      var infowindow = new google.maps.InfoWindow({
      content:"Kecamatan : <b>"+element.namkec+"</b><br /> Jumlah Petani : <b>"+ element.jumlahPetani +" Orang</b>"
      });
