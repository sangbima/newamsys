...
$this->title = 'Map Info Sebaran Petani Per Kelurahan';
...
function initialize() {
  ...
  coba.forEach(function(element,index){
      ...
      position:new google.maps.LatLng(element.kellat,element.kellong),
      });

      pramarker.setMap(map);

      var infowindow = new google.maps.InfoWindow({
      content:"Kelurahan : <b>"+element.namkel+"</b><br /> Jumlah Petani : <b>"+ element.jumlahPetani +" Orang</b>"
      });
