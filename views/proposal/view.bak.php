                            ...
                            <div class="timeline">
                                <dl>
                                    ...
                                    <dd class="pos-right clearfix">
                                        <div class="circ"></div>
                                        <div class="time">14 April, 12:43:50</div>
                                        <div class="events">
                                            <!-- <div class="pull-left">
                                                text
                                            </div> -->
                                            <div class="events-body">
                                                <h4 class="events-heading">Proposal Submit</h4>
                                    ...
                                    <dd class="pos-left clearfix">
                                        <div class="circ"></div>
                                        <div class="time">10 April, 10:40:32</div>
                                        <div class="events">
                                            <!-- <div class="pull-left">
                                                text
                                            </div> -->
                                            <div class="events-body">
                                                <h4 class="events-heading">BGR Setuju</h4>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                            </div>
                                        </div>
                                    </dd>
                                    ...
                                    <dd class="pos-right clearfix">
                                        <div class="circ"></div>
                                        <div class="time">15 Maret, 09:27:23</div>
                                        <div class="events">
                                            <!-- <div class="pull-left">
                                                text
                                            </div> -->
                                            <div class="events-body">
                                                <h4 class="events-heading">ABMI Setuju</h4>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                            </div>
                                        </div>
                                    </dd>
                                    <dd class="pos-left clearfix">
                                        <div class="circ"></div>
                                        <div class="time">08 Maret, 11:40:21</div>
                                        <div class="events">
                                            <!-- <div class="pull-left">
                                                text
                                            </div> -->
                                            <div class="events-body">
                                                <h4 class="events-heading">PPI Tolak</h4>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                            </div>
                                        </div>
                                    </dd>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            ?>
                            <img src="<?=Yii::$app->homeUrl?>uploads/proposal/images/xxx.jpg" class="img-responsive" alt="Foto Lahan Proposal <?=$model->no_proposal?>">
                            <?php
                                } else {
                            ?>
