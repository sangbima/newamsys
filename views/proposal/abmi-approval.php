        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <?= $form->field($model, 'setuju_status[ABMI]')->inline()->radioList(array('Pending'=>'Pending','Setuju'=>'Setuju', 'Tolak'=>'Tolak')); ?>
                    <?= Html::activeHiddenInput($model, 'setuju_status[PPI]') ?>
                </div>
                <div class="col-md-6">
                    <?= $form->field($model, 'est_harga_jual')->widget(\yii\widgets\MaskedInput::className(), [
                        'clientOptions' => [
                            'alias' =>  'decimal',
                            'groupSeparator' => ',',
                            'autoGroup' => true
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?= $form->field($model, 'setuju_alasan[ABMI]')->textArea(['row' => 6]) ?>
                    <?= Html::activeHiddenInput($model, 'setuju_alasan[PPI]') ?>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <?=$form->field($model, 'setuju_berkas[ABMI]')->widget(FileInput::classname(), [
                        'pluginOptions' => [
